...
#include <stddef.h>
#ifdef __BUILD_RTOS_KERNEL__  // cvitek/kernel/CMakeLists.txt, set(SAFETY_FLAGS "-Wall -Wextra -fno-strict-aliasing -static --specs=nosys.specs -D__BUILD_RTOS_KERNEL__") 
#include <stdint.h>
#endif
